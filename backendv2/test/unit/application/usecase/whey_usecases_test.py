...
def test_create_whey_when_all_found(name, price, serving_size, total_weight, protein_per_serving, owner_id):
    ...
    uc = WheyUseCases(mock_whey_repo)
...
def test_create_whey_brand_not_found():
    ...
    mock_whey_repo = Mock()
    mock_whey_repo.create.side_effect = BrandNotFoundException(999)
...
def test_get_whey():
    whey = WheyDetails(id=123, name="test", price=1, brand_id=1, serving_size=1, total_weight=1, protein_per_serving=1, owner_id=None, brand=Brand(id=1, name="brand", logo_url="logo_url", description="description"))
...
def test_update_whey_brand_not_found():
    ...
    mock_whey_repo = Mock()
    mock_whey_repo.update.side_effect = BrandNotFoundException(999)
